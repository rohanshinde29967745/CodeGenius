...
export default function Register({ setPage }) {
    ...
    return (
        <div className="lg-root">
            <form className="lg-card" onSubmit={handleSubmit} aria-labelledby="register-title">
                <div className="lg-header">
                    <h2 id="register-title">Create Account</h2>
                    <p className="muted">Join CodeGenius today</p>
                </div>

                {error && <div className="lg-error" role="alert">{error}</div>}
                {success && <div className="lg-success" role="status">{success}</div>}
                ...
                <div className="lg-socials">
                    ...
                    <button
                        ...
                        onClick={() => alert("Google OAuth integration - implement with Firebase/OAuth")}
                    >
                    ...
                    <button
                        ...
                        onClick={() => alert("GitHub OAuth integration - implement with OAuth")}
                    >
                    ...
                    <button
                        ...
                        onClick={() => alert("Facebook OAuth integration - implement with Facebook SDK")}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
